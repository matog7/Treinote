...
const MyTrainingDashboard: React.FC = () => {
  ...
  const getDaysInMonth = (date: Date) => {
    ...
    for (let i = 1; i <= daysInMonth; i++) {
      ...
      const dayTrainings = trainings.filter((training) => training.date === dateString);
        ...
        <div className='mb-8'>
          <div className='flex items-center justify-between mb-6'>
            <div>
              ...
              <p className='text-lg text-gray-600'>Suivez vos progrès et planifiez vos sessions</p>
            </div>
            <button
            ...
            <div className='bg-white rounded-lg p-6 shadow-lg'>
              <div className='flex items-center'>
                ...
                <div className='ml-4'>
                  ...
                  <p className='text-2xl font-bold text-gray-900'>
                    {Math.round(trainings.reduce((acc, t) => acc + t.duration, 0) / 60)}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className='bg-white rounded-lg p-6 shadow-lg'>
              <div className='flex items-center'>
                ...
                <div className='ml-4'>
                  ...
                  <p className='text-2xl font-bold text-gray-900'>
                    {Math.round(
                      trainings.reduce((acc, t) => acc + t.intensity, 0) / trainings.length
                    )}
                  </p>
                </div>
              </div>
            ...
            <div className='bg-white rounded-2xl shadow-xl p-6'>
                ...
                {trainings.slice(0, 5).map((training) => (
                  ...
                  >
                    <div className='flex items-start justify-between mb-2'>
                      <h3 className='font-semibold text-gray-800 text-sm'>{training.title}</h3>
              ...
              {trainings.length === 0 && (
                <div className='text-center py-8 text-gray-500'>
                  ...
                  <p className='text-sm'>Commencez par ajouter votre premier entraînement !</p>
                </div>
              )}
            </div>
          </div>
