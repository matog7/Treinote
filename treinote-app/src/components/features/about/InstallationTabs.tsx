    ...
    <div className='bg-white rounded-3xl shadow-xl p-8'>
      <div className='text-center mb-8'>
        ...
        <p className='text-lg text-gray-600'>
          Transformez Treinote en application native pour un accès rapide et une expérience optimale
        </p>
      </div>
      ...
      {activeTab === 'iOS' && (
        <div className='bg-blue-50 rounded-2xl p-6 mb-6'>
          <div className='flex items-center space-x-3 mb-6'>
            ...
            <div>
              <h3 className='text-2xl font-bold text-blue-800'>Instructions pour iPhone/iPad</h3>
              <p className='text-blue-700'>Suivez ces étapes simples pour installer Treinote</p>
            </div>
          </div>
              ...
              >
                ...
                <div className='flex-1'>
                  <div className='flex items-center space-x-2 mb-2'>
                    {step.icon}
                    <h4 className='text-blue-800 font-semibold'>{step.title}</h4>
                  </div>
      ...
      {activeTab === 'Android' && (
        <div className='bg-green-50 rounded-2xl p-6 mb-6'>
          <div className='flex items-center space-x-3 mb-6'>
            ...
            <div>
              <h3 className='text-2xl font-bold text-green-800'>Instructions pour Android</h3>
              <p className='text-green-700'>Suivez ces étapes simples pour installer Treinote</p>
            </div>
          </div>
            ...
            {androidSteps.map((step, index) => (
              ...
              >
                ...
                <div className='flex-1'>
                  <div className='flex items-center space-x-2 mb-2'>
                    {step.icon}
                    <h4 className='text-green-800 font-semibold'>{step.title}</h4>
                  </div>
                  <p className='text-green-700 text-sm leading-relaxed'>{step.description}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <div className={`bg-${tabColor}-100 rounded-2xl p-6`}>
        <div className='flex items-center space-x-3 mb-4'>
          ...
          <h4 className={`text-xl font-bold text-${tabColor}-800`}>Conseils d'Installation</h4>
        </div>

        <div className='space-y-3'>
          <div className='flex items-start space-x-3'>
            <CheckCircle className={`w-5 h-5 text-${tabColor}-600 mt-0.5 flex-shrink-0`} />
          ...
          <div className='flex items-start space-x-3'>
            <CheckCircle className={`w-5 h-5 text-${tabColor}-600 mt-0.5 flex-shrink-0`} />
            <p className={`text-${tabColor}-700`}>
              Vous pouvez déplacer l'icône comme n'importe quelle autre application
            </p>
          </div>
        </div>
      </div>
      ...
      {deviceType === 'Desktop' && (
        <div className='mt-6 text-center p-6 bg-blue-50 rounded-2xl'>
          <p className='text-blue-800 mb-4'>
            💡 <strong>Conseil :</strong> Pour une meilleure expérience, testez Treinote sur votre
            smartphone !
          </p>
