  ...
  const filteredEvents = useMemo(() => {
    return events.filter((event) => {
      ...
      const matchesDifficulty =
        ...
        (activeFilters.difficulty === "Débutant" &&
          event.difficulty === "beginner") ||
        (activeFilters.difficulty === "Intermédiaire" &&
          event.difficulty === "intermediate") ||
        (activeFilters.difficulty === "Avancé" &&
      ...
      const matchesPrice =
        ...
        (activeFilters.priceRange === "0-20€" &&
          event.price > 0 &&
          event.price <= 20) ||
        (activeFilters.priceRange === "20-50€" &&
          event.price > 20 &&
          event.price <= 50) ||
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Trouvez et participez aux meilleurs événements de tennis,
            entraînements et compétitions de votre région
          </p>
        </div>
