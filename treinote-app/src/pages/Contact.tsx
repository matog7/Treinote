      ...
      <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 mt-16">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h1 className="text-5xl font-bold text-gray-900 font-audiowide mb-4">
              Contactez-nous
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Prêt à améliorer votre jeu de tennis ? Notre équipe d'experts est
              là pour vous aider. N'hésitez pas à nous contacter pour toute
              question ou demande.
            </p>
          </div>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-8">
                  Que vous soyez débutant ou joueur confirmé, nous avons les
                  ressources et l'expertise pour vous faire progresser.
                  Contactez-nous pour commencer votre voyage vers l'excellence.
                </p>
              </div>
